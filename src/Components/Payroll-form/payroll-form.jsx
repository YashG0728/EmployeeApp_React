...
function  Practiceform() {
  ...
  department : "",salary:"",startDate:"", note:"", update:false})
  ...
  if(startValue.update){
      submitHandler();
  }
  }

  const submitHandler = () => {
  axios.post("http://localhost:9096/addEmployeeData", startValue)
    ...
    <form className='form'>
      ...
      <div className="buttonParent">
        <div className="submit-reset">
            ...
            <button onClick={submitHandler} type="button" className="resetButton">Submit</button> 
